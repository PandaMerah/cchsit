...
class Location extends SnipeModel
{
    ...
    protected $rules = [
        ...
        'location_code' => 'max:10|unique_undeleted',
     ...
     * @var array
     */
    protected $searchableAttributes = ['name', 'address', 'city', 'state', 'zip', 'created_at', 'ldap_ou', 'phone', 'fax', 'notes', 'location_code'];
    ...
    // {
    //     return $this->belongsTo(\App\Models\location_code::class, 'manager_id');
    // }
