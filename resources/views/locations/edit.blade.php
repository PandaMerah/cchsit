...
<div class="form-group  {{ $errors->has('location_code') ? ' has-error' : '' }}">
    <label for="location_code" class="col-md-3 control-label">Location Code</label>
    <div class="col-md-8 col-sm-12">
        <input type="text" class="form-control" name="location_code" id="location_code" value="{{ old('location_code', $item->location_code ?? '') }}" required>
        {!! $errors->first('location_code', '<span class="alert-msg" aria-hidden="true"><i class="fas fa-times" aria-hidden="true"></i> :message</span>') !!}
    </div>
